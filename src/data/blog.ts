...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    keyTakeaways: [
      ...
      "Every plan at Sanjeevani Clinc Pvt. Ltd. is reviewed by a doctor, not just a therapist.",
    ],
    sections: [
      {
      ...
      },
      {
        ...
        list: [
          ...
          "Continuous doctor oversight when arranged through Sanjeevani Clinc Pvt. Ltd..",
      ...
      {
        heading: "How to book with Sanjeevani Clinc Pvt. Ltd.",
        paragraphs: [
  ...
  },
  {
    ...
    featuredImageAlt: "Free eye check-up campaign at Sanjeevani Clinc Pvt. Ltd.",
    intro:
      "Every year, Sanjeevani Clinc Pvt. Ltd. runs a completely free eye check-up drive for families in Kirari, Karan Vihar and the surrounding colonies. It is our way of catching the eye problems that patients would otherwise ignore until vision has already been lost. This year the drive is bigger, and registration is open to anyone above the age of five.",
    keyTakeaways: [
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Most basic reports at Sanjeevani Clinc Pvt. Ltd. are ready the same day. Specialised tests take 24–72 hours.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    intro:
      "Most 'executive health check-ups' are enormous packages padded with tests you do not need, priced to look thorough. A good annual check-up is the opposite: tight, purposeful and matched to your age, gender and family history. Here is what we actually order for our patients at Sanjeevani Clinc Pvt. Ltd..",
    keyTakeaways: [
