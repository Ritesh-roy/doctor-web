...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    keyTakeaways: [
      ...
      "Every plan at Sanjeevani Clinic is reviewed by a doctor, not just a therapist.",
    ],
    sections: [
      {
      ...
      },
      {
        ...
        list: [
          ...
          "Continuous doctor oversight when arranged through Sanjeevani Clinic.",
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Most basic reports at Sanjeevani Clinic are ready the same day. Specialised tests take 24–72 hours.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    intro:
      "Most 'executive health check-ups' are enormous packages padded with tests you do not need, priced to look thorough. A good annual check-up is the opposite: tight, purposeful and matched to your age, gender and family history. Here is what we actually order for our patients at Sanjeevani Clinic.",
    keyTakeaways: [
