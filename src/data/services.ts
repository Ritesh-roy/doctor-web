...
export const SERVICES: Service[] = [
  ...
  ...([
    ...
    ["senior-citizen-care","Senior Citizen Care","heart","Gentle, patient care for elders — home visits & regular check-ins.","Regular BP/sugar reviews, medication adjustments, physiotherapy and family counselling for seniors.","/photos/family-with-doctor.jpg",undefined,"Programme",true],
