...
export const Route = createFileRoute("/pharmacy")({
  ...
  head: () => ({
    meta: [
      { title: "In-house Pharmacy — Sanjeevani Clinic, Kirari, Delhi" },
      {
        name: "description",
        content:
          "Sanjeevani Clinic's in-house pharmacy stocks genuine medicines, chronic-care refills and OTC essentials, with prescription verification by our doctor.",
      },
      { name: "keywords", content: "pharmacy Kirari, medicines near me, chronic care refills, Sanjeevani Clinic pharma" },
      { property: "og:title", content: "In-house Pharmacy — Sanjeevani Clinic" },
...
function Pharmacy() {
  return (
    <SiteLayout>
      <PageHero
        eyebrow="Sanjeevani Clinic Pharma"
