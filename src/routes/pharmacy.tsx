...
export const Route = createFileRoute("/pharmacy")({
  ...
  head: () => ({
    meta: [
      { title: "In-house Pharmacy — Sanjeevani Clinic Private Limited, Kirari, Delhi" },
      {
        name: "description",
        content:
          "Sanjeevani Clinic Private Limited's in-house pharmacy stocks genuine medicines, chronic-care refills and OTC essentials, with prescription verification by our doctor.",
      },
      { name: "keywords", content: "pharmacy Kirari, medicines near me, chronic care refills, Sanjeevani Clinic Private Limited pharma" },
      { property: "og:title", content: "In-house Pharmacy — Sanjeevani Clinic Private Limited" },
...
function Pharmacy() {
  return (
    <SiteLayout>
      <PageHero
        eyebrow="Sanjeevani Clinic Private Limited Pharma"
