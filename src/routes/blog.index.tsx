...
export const Route = createFileRoute("/blog/")({
  ...
  head: () => ({
    meta: [
      { title: "Health Blog & Guides — Sanjeevani Clinic, Kirari, Delhi" },
      {
        name: "description",
        content:
          "Reliable, doctor-reviewed articles on physiotherapy, eye care, diagnostics, general medicine and preventive health from Sanjeevani Clinic, Kirari.",
      },
      ...
      { property: "og:title", content: "Health Blog & Guides — Sanjeevani Clinic" },
