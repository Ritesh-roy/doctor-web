...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      { title: "Contact — Sanjeevani Clinlc, Kirari, Delhi" },
      { name: "description", content: `Visit Sanjeevani Clinlc at ${CLINIC.address}. Call ${CLINIC.phone} or email ${CLINIC.email}.` },
      { property: "og:title", content: "Contact — Sanjeevani Clinlc" },
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-4 pb-16 sm:px-6 sm:pb-24 lg:grid-cols-[1fr_1.1fr]">
        ...
        <div>
          ...
          <div className="mt-6 overflow-hidden rounded-3xl border border-primary/10 shadow-card">
            <iframe
              title="Sanjeevani Clinlc location"
              src={CLINIC.mapEmbed}
              loading="lazy"
