...
export const Route = createFileRoute("/testimonials")({
  ...
  head: () => ({
    meta: [
      { title: "Reviews — Sanjeevani Clinc Pvt. Ltd., Kirari" },
      { name: "description", content: "What Kirari families say about Sanjeevani Clinc Pvt. Ltd. and Dr. B.P. Singh." },
      { property: "og:title", content: "Patient Reviews — Sanjeevani Clinc Pvt. Ltd." },
