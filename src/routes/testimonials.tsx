...
export const Route = createFileRoute("/testimonials")({
  ...
  head: () => ({
    meta: [
      { title: "Reviews — Sanjeevani Clinic Private Limited, Kirari" },
      { name: "description", content: "What Kirari families say about Sanjeevani Clinic Private Limited and Dr. B.P. Singh." },
      { property: "og:title", content: "Patient Reviews — Sanjeevani Clinic Private Limited" },
