...
export const Route = createFileRoute("/book-appointment")({
  ...
  head: () => ({
    meta: [
      { title: "Book Appointment — Sanjeevani Clinc Pvt. Ltd., Kirari" },
      { name: "description", content: "Book your appointment with Dr. B.P. Singh at Sanjeevani Clinc Pvt. Ltd., Kirari, Delhi." },
      { property: "og:title", content: "Book Appointment — Sanjeevani Clinc Pvt. Ltd." },
