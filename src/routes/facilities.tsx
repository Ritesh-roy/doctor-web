...
export const Route = createFileRoute("/facilities")({
  ...
  head: () => ({
    meta: [
      { title: "Our Facilities — Sanjeevani Clinc Private Limited, Kirari" },
      ...
      { property: "og:title", content: "Our Facilities — Sanjeevani Clinc Private Limited" },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Every corner of Sanjeevani Clinc Private Limited is designed for one thing — to help you feel cared for from the moment you walk in."
