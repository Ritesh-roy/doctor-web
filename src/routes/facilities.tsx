...
export const Route = createFileRoute("/facilities")({
  ...
  head: () => ({
    meta: [
      { title: "Our Facilities — Sanjeevani Clinlc, Kirari" },
      ...
      { property: "og:title", content: "Our Facilities — Sanjeevani Clinlc" },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Every corner of Sanjeevani Clinlc is designed for one thing — to help you feel cared for from the moment you walk in."
