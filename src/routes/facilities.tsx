...
export const Route = createFileRoute("/facilities")({
  ...
  head: () => ({
    meta: [
      { title: "Our Facilities — Sanjeevani Clinc Pvt. Ltd., Kirari" },
      ...
      { property: "og:title", content: "Our Facilities — Sanjeevani Clinc Pvt. Ltd." },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Every corner of Sanjeevani Clinc Pvt. Ltd. is designed for one thing — to help you feel cared for from the moment you walk in."
