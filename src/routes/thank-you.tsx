...
export const Route = createFileRoute("/thank-you")({
  ...
  head: () => ({
    meta: [
      { title: "Thank You — Sanjeevani Clinc Private Limited" },
      { name: "description", content: "Thank you for booking with Sanjeevani Clinc Private Limited. Your appointment details are below." },
...
<body><h1>Sanjeevani Clinc Private Limited Private Limited</h1>
...
<p style="color:#64748b;font-size:12px;margin-top:24px">Thank you for choosing Sanjeevani Clinc Private Limited. This is a system-generated invoice.</p>
</body></html>`;
}
