...
export const Route = createFileRoute("/thank-you")({
  ...
  head: () => ({
    meta: [
      { title: "Thank You — Sanjeevani Clinc Pvt. Ltd." },
      { name: "description", content: "Thank you for booking with Sanjeevani Clinc Pvt. Ltd.. Your appointment details are below." },
...
<body><h1>Sanjeevani Clinc Pvt. Ltd.</h1>
...
<p style="color:#64748b;font-size:12px;margin-top:24px">Thank you for choosing Sanjeevani Clinc Pvt. Ltd.. This is a system-generated invoice.</p>
</body></html>`;
}
