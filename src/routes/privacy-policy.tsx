...
export const Route = createFileRoute("/privacy-policy")({
  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy — Sanjeevani Clinlc" },
      { name: "description", content: "How Sanjeevani Clinlc collects, uses and protects your personal and medical information." },
  ...
  return (
    <SiteLayout>
      ...
      <article className="mx-auto max-w-3xl px-4 pb-16 sm:px-6 sm:pb-24 [&_h2]:font-display [&_h2]:text-2xl [&_h2]:text-foreground [&_h2]:mt-10 [&_h2]:mb-3 [&_p]:text-muted-foreground [&_p]:leading-relaxed [&_ul]:mt-2 [&_ul]:list-disc [&_ul]:pl-6 [&_li]:text-muted-foreground">
        <p>
          This page is maintained by Sanjeevani Clinlc to answer common privacy questions about how we handle your information when you visit our website or receive care at our clinic in Kirari, Delhi.
        </p>
