...
export const Route = createFileRoute("/terms")({
  ...
  head: () => ({
    meta: [
      { title: "Terms & Conditions — Sanjeevani Clinc Pvt. Ltd." },
      { name: "description", content: "Terms governing the use of Sanjeevani Clinc Pvt. Ltd.'s website and services." },
  ...
  return (
    <SiteLayout>
      ...
      <article className="mx-auto max-w-3xl px-4 pb-16 sm:px-6 sm:pb-24 [&_h2]:font-display [&_h2]:text-2xl [&_h2]:text-foreground [&_h2]:mt-10 [&_h2]:mb-3 [&_p]:text-muted-foreground [&_p]:leading-relaxed">
        <p>These terms are maintained by Sanjeevani Clinc Pvt. Ltd. and apply to visits to our website and to services provided at our clinic in Kirari, Delhi.</p>
        ...
        <p>All content and design on this site are owned by Sanjeevani Clinc Pvt. Ltd.. Please do not reuse without written permission.</p>
        <h2>Contact</h2>
