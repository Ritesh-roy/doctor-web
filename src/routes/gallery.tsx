...
export const Route = createFileRoute("/gallery")({
  ...
  head: () => ({
    meta: [
      { title: "Gallery — Sanjeevani Clinlc, Kirari, Delhi" },
      { name: "description", content: "A look inside Sanjeevani Clinlc — our clinic, doctor, team, community camps and awards." },
      { property: "og:title", content: "Gallery — Sanjeevani Clinlc" },
...
const items: GalleryItem[] = [
  {
    ...
    alt: "Real hijama / cupping therapy session at Sanjeevani Clinlc",
    title: "Cupping Therapy — In Action",
    category: "Clinic",
    description:
      "A real cupping therapy session at Sanjeevani Clinlc. Every cup is sterile, single-use and applied by a trained therapist — helpful for back pain, muscle tension and general detoxification.",
    location: "Sanjeevani Clinlc · Karan Vihar",
  },
  {
    src: "/photos/massage-back-real.jpg",
    alt: "Deep-tissue back massage therapy at Sanjeevani Clinlc",
  ...
  },
  {
    ...
    category: "Doctor",
    description:
      "Same doctor, same values — in the upgraded, brightly-lit consulting room of today's Sanjeevani Clinlc.",
  },
  {
  ...
  },
  {
    ...
    alt: "Sanjeevani Clinlc front entrance in Karan Vihar, Kirari",
    title: "Sanjeevani Clinlc — Karan Vihar",
    category: "Clinic",
    description:
  ...
  },
  {
    ...
    alt: "Sanjeevani Clinlc street view",
    title: "A familiar corner of Kirari",
    category: "Clinic",
    description:
      "You can spot the red Sanjeevani Clinlc signboard from the top of Karan Vihar Road. A quiet, easy landmark for anyone walking in for the first time.",
  ...
  },
  {
    ...
    alt: "Sanjeevani Clinlc team selfie",
  ...
  },
  {
    ...
    category: "Awards",
    description:
      "Awarded to Dr. Bhanu Pratap Singh (Director, Sanjeevani Clinlc) for Outstanding Contribution to Healthcare Services.",
    date: "21 May 2026",
...
function Gallery() {
  ...
  return (
    <SiteLayout>
      <PageHero
        eyebrow="Gallery"
        title="A look inside Sanjeevani Clinlc."
