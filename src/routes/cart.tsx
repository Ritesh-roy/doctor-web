...
export const Route = createFileRoute("/cart")({
  ...
  head: () => ({
    meta: [
      { title: "Your Cart — Sanjeevani Clinic Private Limited" },
      { name: "description", content: "Review the services in your Sanjeevani Clinic Private Limited cart before checkout." },
