...
export const Route = createFileRoute("/forgot-password")({
  ...
  head: () => ({
    meta: [
      { title: "Forgot Password — Sanjeevani Clinic Private Limited" },
      { name: "description", content: "Reset your Sanjeevani Clinic Private Limited password via a link sent to your email." },
