...
export const Route = createFileRoute("/forgot-password")({
  ...
  head: () => ({
    meta: [
      { title: "Forgot Password — Sanjeevani Clinc Private Limited" },
      { name: "description", content: "Reset your Sanjeevani Clinc Private Limited password via a link sent to your email." },
