...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      { title: "About Sanjeevani Clinlc — Family Healthcare in Kirari, Delhi" },
      { name: "description", content: "Since 2009, Sanjeevani Clinlc has cared for families across Karan Vihar and Kirari with honest, evidence-based medicine led by Dr. B.P. Singh." },
      { property: "og:title", content: "About Sanjeevani Clinlc" },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Founded on the belief that ‘Sehat hi asli sampatti hai’, Sanjeevani Clinlc has been the trusted first point of care for Kirari families for over 15 years."
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/60 bg-white shadow-glow">
              <img src="/photos/clinic-front.jpg" alt="Sanjeevani Clinlc — Karan Vihar, Kirari, Delhi" loading="lazy" className="aspect-[4/5] w-full object-cover" />
            </div>
          </div>
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              Sanjeevani Clinlc opened its doors in {CLINIC.since} on Karan Vihar Road with a single consulting room, a small pharmacy shelf and one clear promise:
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <img src="/photos/doctor-desk-1.jpg" alt="Dr. B.P. Singh consulting a patient at Sanjeevani Clinlc" loading="lazy" className="aspect-[4/3] w-full rounded-2xl object-cover shadow-card" />
              <img src="/photos/clinic-street-bw.jpg" alt="Sanjeevani Clinlc street view" loading="lazy" className="aspect-[4/3] w-full rounded-2xl object-cover shadow-card" />
            </div>
          </div>
        </div>
      </section>
    ...
    <section id="team" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
      ...
      <div className="relative mt-12 overflow-hidden rounded-[32px] border border-white/60 shadow-glow">
        <img
          ...
          alt="The Sanjeevani Clinlc team at Karan Vihar, Kirari"
          loading="lazy"
          ...
          {TEAM.map((m, i) => (
            ...
            >
              ...
              <div className="mt-5 flex items-center justify-between border-t border-primary/10 pt-4 text-xs">
                <span className="text-muted-foreground">Sanjeevani Clinlc</span>
