...
export const Route = createFileRoute("/faqs")({
  ...
  head: () => ({
    meta: [
      { title: "FAQs — Sanjeevani Clinlc, Kirari" },
      { name: "description", content: "Answers to the most common questions about appointments, timings, services and payments at Sanjeevani Clinlc." },
      { property: "og:title", content: "FAQs — Sanjeevani Clinlc" },
