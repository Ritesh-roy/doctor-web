...
export const Route = createFileRoute("/faqs")({
  ...
  head: () => ({
    meta: [
      { title: "FAQs — Sanjeevani Clinc Pvt. Ltd., Kirari" },
      { name: "description", content: "Answers to the most common questions about appointments, timings, services and payments at Sanjeevani Clinc Pvt. Ltd.." },
      { property: "og:title", content: "FAQs — Sanjeevani Clinc Pvt. Ltd." },
