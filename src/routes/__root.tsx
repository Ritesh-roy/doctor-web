  ...
  head: () => ({
    meta: [
      ...
      { title: "Sanjeevani Clinc Private Limited — Trusted Family Healthcare in Kirari, Delhi" },
      {
        name: "description",
        content:
          "Sanjeevani Clinc Private Limited in Karan Vihar, Kirari, Delhi. 15+ years of trusted care led by Dr. B.P. Singh — physiotherapy, diagnostics, radiology, eye care and family medicine.",
      },
      { name: "author", content: "Sanjeevani Clinc Private Limited" },
      { property: "og:site_name", content: "Sanjeevani Clinc Private Limited" },
