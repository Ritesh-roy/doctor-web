...
export const Route = createFileRoute("/shop")({
  ...
  head: () => ({
    meta: [
      { title: "Shop All Services — Sanjeevani Clinlc" },
      { name: "description", content: "Browse all Sanjeevani Clinlc services and packages — physiotherapy, blood tests, radiology, eye care and more. Book online with transparent pricing." },
      { property: "og:title", content: "Shop All Services — Sanjeevani Clinlc" },
      { property: "og:description", content: "Every service and package offered by Sanjeevani Clinlc with real prices." },
