...
export const Route = createFileRoute("/shop")({
  ...
  head: () => ({
    meta: [
      { title: "Shop All Services — Sanjeevani Clinc Pvt. Ltd." },
      { name: "description", content: "Browse all Sanjeevani Clinc Pvt. Ltd. services and packages — physiotherapy, blood tests, radiology, eye care and more. Book online with transparent pricing." },
      { property: "og:title", content: "Shop All Services — Sanjeevani Clinc Pvt. Ltd." },
      { property: "og:description", content: "Every service and package offered by Sanjeevani Clinc Pvt. Ltd. with real prices." },
