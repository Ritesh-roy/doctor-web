...
export const Route = createFileRoute("/cancel-payment")({
  ...
  head: () => ({
    meta: [
      { title: "Payment Cancelled — Sanjeevani Clinlc" },
      { name: "description", content: "Your payment for the Sanjeevani Clinlc service was cancelled and no amount has been charged." },
