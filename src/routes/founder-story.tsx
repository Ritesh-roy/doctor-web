  ...
  head: () => ({
    meta: [
      { title: "Founder Story — Dr. B.P. Singh | Sanjeevani Clinic Pvt. Ltd." },
      {
        name: "description",
        content:
          "The story of Mr. D.R. B.P. Singh — founder & director of Sanjeevani Clinic Pvt. Ltd. Pvt. Ltd. From a single room in 2009 to a mission to bring affordable, ethical healthcare to every Indian family.",
      },
...
const TIMELINE = [
  ...
  {
    year: "2021",
    title: "Sanjeevani Clinic Pvt. Ltd. Pvt. Ltd. — a mission, not a business",
    body: "Sanjeevani Clinic Pvt. Ltd. Private Limited is formalised — not just as a healthcare company, but as a mission to build healthier communities, generate employment and empower local entrepreneurs.",
    icon: Target,
  },
  {
    year: "2023",
...
const AUTOBIOGRAPHY = [
  ...
  "With this purpose, we built Sanjeevani Clinic Pvt. Ltd. Private Limited — not just as a healthcare company, but as a mission to create healthier communities while generating employment opportunities and empowering local entrepreneurs.",
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="The story of Mr. D.R. B.P. Singh — Founder & Director of Sanjeevani Clinic Pvt. Ltd. Pvt. Ltd., visionary healthcare entrepreneur and the man behind NEOREO Healthcare."
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[32px] border border-white/60 bg-white shadow-glow">
              <img
                ...
                alt="Mr. D.R. B.P. Singh — Founder, Sanjeevani Clinic Pvt. Ltd. Pvt. Ltd."
                loading="eager"
          ...
          <div>
            ...
            <p className="mt-2 text-sm font-medium text-emerald-accent">
              Visionary Healthcare Entrepreneur · Sanjeevani Clinic Pvt. Ltd. Pvt. Ltd.
            </p>
        ...
        <div className="rounded-[32px] border border-primary/10 bg-gradient-to-br from-primary-soft/40 to-white p-8 sm:p-12">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-3 border-t border-primary/10 pt-6">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">Founder &amp; Director · Sanjeevani Clinic Pvt. Ltd. Private Limited</div>
            </div>
          </div>
        </div>
      </section>
