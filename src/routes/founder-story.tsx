...
export const Route = createFileRoute("/founder-story")({
  ...
  head: () => ({
    meta: [
      { title: "Founder Story — Dr. B.P. Singh | Sanjeevani Clinic" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Founder Story — Dr. B.P. Singh" },
      {
        ...
        content:
          "From a single room in 2009 to Sardar Patel Unity Award 2026 — the journey of the founder of Sanjeevani Clinic and NEOREO Healthcare.",
      },
...
const TIMELINE = [
  ...
  },
  {
    ...
    body: "Sanjeevani Clinic Private Limited is formalised — not just as a healthcare company, but as a mission to build healthier communities, generate employment and empower local entrepreneurs.",
    icon: Target,
  },
  {
    year: "2023",
...
const AUTOBIOGRAPHY = [
  ...
  "With this purpose, we built Sanjeevani Clinic Private Limited — not just as a healthcare company, but as a mission to create healthier communities while generating employment opportunities and empowering local entrepreneurs.",
        ...
        <div className="rounded-[32px] border border-primary/10 bg-gradient-to-br from-primary-soft/40 to-white p-8 sm:p-12">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-3 border-t border-primary/10 pt-6">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">Founder &amp; Director · Sanjeevani Clinic Private Limited</div>
            </div>
          </div>
        </div>
      </section>
