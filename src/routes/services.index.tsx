...
export const Route = createFileRoute("/services/")({
  ...
  head: () => ({
    meta: [
      { title: "Services — Sanjeevani Clinic Pvt. Ltd., Kirari Delhi" },
      ...
      { property: "og:title", content: "All Services — Sanjeevani Clinic Pvt. Ltd." },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Explore the full range of services at Sanjeevani Clinic Pvt. Ltd.. Each is doctor-led, evidence-based and delivered with the warmth we're known for."
