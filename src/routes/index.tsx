      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 pt-10 pb-16 sm:px-6 sm:pt-16 sm:pb-24 lg:grid-cols-[1.1fr_1fr] lg:items-center lg:gap-16 lg:pt-20 lg:pb-28">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.1 }} className="relative">
          <div className="relative mx-auto aspect-[4/5] w-full max-w-md">
            ...
            {/* MBBS & Family Physician glass badge */}
            <motion.div
              animate={{ y: [0, -10, 0] }}
            ...
            >
              ...
              <div>
                <div className="text-sm font-semibold text-foreground">MBBS & Family Physician</div>
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
      <div className="mx-auto mb-12 max-w-2xl text-center">
        ...
        <p className="mt-4 text-muted-foreground">Doctor-led service lines and therapies — thoughtfully coordinated by one clinical team.</p>
      </div>
        ...
        {cards.map((c) => {
          ...
          return (
            <Link
              key={c.key}
              to={c.href.to}
              params={(c.href.params ?? undefined) as never}
              className="group flex h-full flex-col overflow-hidden rounded-3xl border border-primary/10 bg-white shadow-card transition-transform hover:-translate-y-1"
            >
