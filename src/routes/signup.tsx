...
export const Route = createFileRoute("/signup")({
  ...
  head: () => ({
    meta: [
      { title: "Create Account — Sanjeevani Clinc Pvt. Ltd." },
      { name: "description", content: "Create your Sanjeevani Clinc Pvt. Ltd. account using email or mobile and a password." },
