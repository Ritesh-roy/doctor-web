...
export const Route = createFileRoute("/appointment-cancellation-confirmation")({
  ...
  head: () => ({
    meta: [
      { title: "Cancellation Confirmed — Sanjeevani Clinic Private Limited" },
      { name: "description", content: "We have confirmed the cancellation of your Sanjeevani Clinic Private Limited appointment." },
