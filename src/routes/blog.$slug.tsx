...
export const Route = createFileRoute("/blog/$slug")({
  ...
  head: ({ loaderData, params }) => {
    if (!loaderData) {
      return { meta: [{ title: "Article Not Found — Sanjeevani Clinic Private Limited" }, { name: "robots", content: "noindex" }] };
    }
    const p = loaderData.post;
    return {
      meta: [
        { title: `${p.title} — Sanjeevani Clinic Private Limited Blog` },
        { name: "description", content: p.excerpt },
        { name: "keywords", content: `${p.category}, health blog Delhi, Sanjeevani Clinic Private Limited Kirari` },
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            publisher: { "@type": "MedicalClinic", name: "Sanjeevani Clinic Private Limited" },
          }),
        },
      ],
    };
    ...
    <SiteLayout>
      ...
      <article className="mx-auto max-w-3xl px-4 pb-16 sm:px-6 sm:pb-24">
        ...
        <div className="mt-12 rounded-3xl border border-primary/10 bg-gradient-to-br from-primary-soft/50 to-white p-6 sm:p-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Book a short consultation with Dr. B.P. Singh at Sanjeevani Clinic Private Limited, or WhatsApp us and we will guide you.</p>
