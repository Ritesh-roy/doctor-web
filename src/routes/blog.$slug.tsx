      ...
      {!post.video && (
        <section className="mx-auto max-w-4xl px-4 pb-8 sm:px-6">
          <div className="flex aspect-video items-center justify-center overflow-hidden rounded-3xl border border-primary/10 bg-primary-soft/30 p-12 shadow-glow">
            <img src="/logo-full.png" alt="Sanjeevani Clinic logo" className="h-full w-full object-contain" loading="eager" />
          </div>
        </section>
      )}
            ...
            {relatedPosts.map((r) => (
              ...
              >
                <div className="flex aspect-[16/10] items-center justify-center overflow-hidden bg-primary-soft/30 p-5">
                  <img src="/logo-full.png" alt="Sanjeevani Clinic logo" loading="lazy" className="h-full w-full object-contain transition-transform duration-500 group-hover:scale-105" />
                </div>
                <div className="p-4">
