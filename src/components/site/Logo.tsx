...
export function Logo({ compact = false }: { compact?: boolean }) {
  return (
    <Link to="/" className="flex min-w-0 items-center gap-2.5 shrink-0" aria-label="Sanjeevani Clinic Pvt. Ltd. — Home">
      ...
      {!compact && (
        <span className="min-w-0 leading-tight">
          <span className="block font-display text-sm font-semibold text-foreground sm:text-base xl:text-lg">
            ...
            <span className="hidden xl:inline">Sanjeevani Clinic Pvt. Ltd.</span>
          </span>
