      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1fr]">
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-display text-xl font-semibold">Sanjeevani Clinc Private Limited</div>
        ...
        <div className="mt-12 flex flex-col-reverse items-start justify-between gap-6 border-t border-background/10 pt-6 sm:flex-row sm:items-center">
          <p className="text-xs text-background/60">
            © {new Date().getFullYear()} Sanjeevani Clinc Private Limited · All rights reserved.
          </p>
